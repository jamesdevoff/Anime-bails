...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:wanz8creator/bail"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    url: "https://t.me/mamangwanzzselaluamanah",
    body: "Nak jadi dev",
    footer: "Footer",
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"wanzz\",\"url\":\"https://t.me/mamangwanzzselaluamanah\"}"
      }
    ],
